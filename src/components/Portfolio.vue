...
const meusProjetos = ref([

 {
  ...
  link: 'https://meu-painel-rk75.vercel.app/', // Padronizado para 'link' para funcionar no template geral

  link_painel_administrativo: 'https://meu-painel-rk75.vercel.app/', // CORRIGIDO AQUI (Removido o espaço em branco)
      ...
      >
        ...
        <div class="project-info">
          ...
          <div class="project-actions">
            ...
            <a v-if="projeto.link_painel_administrative" :href="projeto.link_painel_administrative" target="_blank" rel="noopener" class="btn-project-link" style="color: #64748b;">
